      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51Ib8wTSBXzEpm5kMNtQCsrBzW8o11nDa9HWOSK7bACQIXt1PHvaisWJ9oL74cMRAW2I4rVAX4mzZ52xdPA4zh1mG00tCdSMQYp');
          ...
          case 8:
            paymentType.addEventListener('change', function (e) {
              if (e.target.value === 'card') {
                // Display Widget
                mountWidget(); //  card = new CardWidget(stripe)
                //  card.mount()
              } else {
                card.destroy();
              }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkFoodDeliverySystem"] = self["webpackChunkFoodDeliverySystem"] || [];
